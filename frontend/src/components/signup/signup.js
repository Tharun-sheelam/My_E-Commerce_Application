...
const Registration = () =>{
 ...
 // const [ setFormErrors] = useState({});
  ...
  if (password !== confirmPassword) {
    setFailMessage('Password and Confirm Password do not match.');
    return;
  }
    ...
    axios.post('http://localhost:8080/shoppinghub/createuser', data)
      ...
      .catch(error => {
        ...
        setFailMessage('An account with this email already exists. Please log in or use a different email.');
